package org.hiedacamellia.danmakutest;
...
public class Danmukutest {
    ...
    public static final String MODID = "danmakutest";
    ...
    public Danmukutest() {
        ...
        Regitem.REGISTRY.register(modEventBus);
        // Register the Deferred Register to the mod event bus so tabs get registered
        Testtab.REGISTRY.register(modEventBus);
